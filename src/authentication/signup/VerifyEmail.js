...
const VerifyEmail = () => {
    ...
    <AuthBackground>
        ...
        <h5 style={{marginTop:'5%', fontWeight:'bold', color:'#484848'}}>Email Verification</h5>
        <p style={{textAlign:'center', fontSize:'12px'}}>Enter the verification code sent to Peterenumah@gmail.com</p>

        <Form>
        <label style={{fontWeight:'bold', color:'#484848'}}>input code</label>   
        <OtpInput
            value={otp}
        ...
        />
         <LongButton style={{ marginTop:'5%'}}>Verify</LongButton>
            <p style={{color:'#ff2957', fontWeight:'bold',textAlign:'center', fontSize:'12px', marginTop:'20px'}}>Resend code</p>
        </Form>
